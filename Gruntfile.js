...
module.exports = function (grunt) {
                ...
                files: [
                    {
                        cwd: 'src/text',
                        src: ['license.txt'],
                        dest: 'dist/paste-it-cleaned-tiny',
                        expand: true,
                    },
                    { src: ['changelog.txt'], dest: 'dist/paste-it-cleaned-tiny', expand: true },
                ],
            },
        },
    ...
    grunt.registerTask('version', 'Creates a version file', function () {
        grunt.file.write('dist/paste-it-cleaned-tiny/version.txt', BUILD_VERSION)
    })

    grunt.registerTask('default', ['clean', 'tslint', 'shell', 'rollup', 'uglify', 'concat', 'copy', 'version'])
}
